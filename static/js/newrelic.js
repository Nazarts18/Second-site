...
__nr_require = function(t, e, n) {
    ...
    5: [function(t, e, n) {
        ...
        function o(t) {
            if (s(m, [window.performance.getEntriesByType(v)]),
            window.performance["c" + d])
                try {
                    window.performance[l](h, o, !1)
                } catch (t) {}
            else
                try {
                    window.performance[l]("webkit" + h, o, !1)
                } catch (t) {}
        }
        function i(t) {}
        if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
            ...
            if (!R.disabled) {
                ...
                a.on(y, function(t, e) {
                    var n = t[0];
                    n instanceof O && (this.bstStart = R.now())
                }),
                a.on(x, function(t, e) {
                    var n = t[0];
                    n instanceof O && s("bst", [n, e, this.bstStart, R.now()])
                }),
                c.on(y, function(t, e, n) {
                    this.bstStart = R.now(),
                    this.bstType = n
                }),
                c.on(x, function(t, e) {
                    s(b, [e, this.bstStart, R.now(), this.bstType])
                }),
                f.on(y, function() {
                    this.bstStart = R.now()
                }),
                f.on(x, function(t, e) {
                    s(b, [e, this.bstStart, R.now(), "requestAnimationFrame"])
                }),
                a.on(E + w, function(t) {
                    this.time = R.now(),
                ...
                u() ? (s(m, [window.performance.getEntriesByType("resource")]),
                r()) : p in window.performance && (window.performance["c" + d] ? window.performance[p](h, o, !1) : window.performance[p]("webkit" + h, o, !1)),
                document[p]("scroll", i, {
                    passive: !0
                }),
                document[p]("keypress", i, !1),
                document[p]("click", i, !1)
            }
        }
    }
    , {}],
    ...
    12: [function(t, e, n) {
        ...
        ["resolve", "reject"].forEach(function(t) {
            ...
            f[t] = function(t) {
                ...
                return t !== n && i.emit("propagate", [t, !0], n, !1, !1),
                n
            }
        }),
    ...
    16: [function(t, e, n) {
        function r(t) {
            ...
            return (t.sameOrigin || c(t) && p()) && (w.traceContextParentHeader = o(h, m),
        ...
        function c(t) {
            var e = !1
              , n = {};
            if ("init"in NREUM && "distributed_tracing"in NREUM.init && (n = NREUM.init.distributed_tracing),
            t.sameOrigin)
                e = !0;
    ...
    17: [function(t, e, n) {
        ...
        if (a.xhrWrappable && !a.disabled) {
            ...
            u.on("new-xhr", function(t) {
                ...
                h && (h > 34 || h < 10) || t.addEventListener("progress", function(t) {
                    e.lastSize = t.loaded
                }, !1)
            }),
            ...
            u.on("open-xhr-end", function(t, e) {
                ...
                if (n) {
                    ...
                    r = !0),
                    n.traceContextParentHeader && (e.setRequestHeader("traceparent", n.traceContextParentHeader),
            ...
            u.on("fn-start", function(t, e, n) {
                e instanceof g && ("onload" === n && (this.onload = !0),
            ...
            u.on("fetch-before-start", function(t) {
                function e(t, e) {
                    ...
                    n = !0),
                    e.traceContextParentHeader && (t.set("traceparent", e.traceContextParentHeader),
            ...
            u.on("fetch-start", function(t, e) {
                ...
                "string" == typeof i ? n = i : "object" == typeof i && i instanceof w ? n = i.url : window.URL && "object" == typeof i && i instanceof URL && (n = i.href),
                o(this, n);
    ...
    26: [function(t, e, n) {
        ...
        if (!("init"in NREUM && "page_view_timing"in NREUM.init && "enabled"in NREUM.init.page_view_timing && NREUM.init.page_view_timing.enabled === !1)) {
            var c, f, u, d = t("handle"), p = t("loader"), l = t(29), h = NREUM.o.EV;
    ...
    29: [function(t, e, n) {
        ...
        i = "visibilitychange",
        a = "visibilityState") : "undefined" != typeof document.msHidden ? (o = "msHidden",
    ...
    loader: [function(t, e, n) {
        ...
        var b = "" + location
          , E = {
            ...
            agent: "js-agent.newrelic.com/nr-spa-1211.min.js"
        }
        ...
        if (!x) {
            t(20),
            t(26),
            m[v] ? (m[v]("DOMContentLoaded", i, !1),
            h[v]("load", r, !1)) : (m[w]("onreadystatechange", o),
            h[w]("onload", r)),
...
;NREUM.loader_config = {
    ...
    trustKey: "3283134",
    agentID: "1258840121",
    licenseKey: "NRJS-610eb81c85b11f6dea1",
    applicationID: "1258840121"
};
NREUM.info = {
    beacon: "bam.nr-data.net",
    errorBeacon: "bam.nr-data.net",
